...
### 1. Las alertas de precio van al admin, no al usuario
...
### 2. Mercado Libre no actualiza precios automáticamente
...
### 3. El estado "En watchlist" se pierde al recargar la página
...
### 4. `init.sql` no coincide con el schema real
...
### 5. La Política de privacidad contradice la app real
...
### 6. `ProductCard.jsx` es un componente sin uso
...
### 7. El botón de la campana no tiene funcionalidad
...
### 8. El timer de actualización es un hardcode frágil
...
### 9. Errores silenciosos en delete y setTarget
...
### 10. No hay manejo de JWT expirado (token de 7 días)
